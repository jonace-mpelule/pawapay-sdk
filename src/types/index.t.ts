...
type RequestBuildPayoutResponseDuplicateIgnored =
  RequestBuildPayoutResponseBase & {
    status: "DUPLICATE_IGNORED";
  };
...
export interface AvailableCorrespondentResponse
  extends Countries<CorrespondentData> {}
